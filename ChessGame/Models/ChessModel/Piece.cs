...
{
    /// <summary>An enum representing the color of a piece.
    /// Can be <c>None</c>, <c>White</c> or <c>Black</c></summary>
    ...
    /// <summary>An enum representing the type of a piece.
    /// Can be <c>None</c>, <c>Pawn</c>, <c>Knight</c>, <c>Bishop</c>, <c>Rook</c>, <c>Queen</c> or <c>King</c></summary>
    ...
    public static class AddOnType
    {
        ...
        /// <summary>A method that returns the opposite color.</summary>
        /// <example>colorBlack = colorWhite.Reverse();</example>
    ...
    /// <summary>A class representing a piece on the board. It can represent empty square too.</summary>
    public class Piece
    {
        ...
        /// <summary>Constructor for a chess piece.</summary>
        ...
        /// <summary>Get all the legal moves for this piece with the current board.</summary>
        /// <returns>A list of moves that are legal.</returns>
        ...
        /// <summary>Get the pseudo-moves for this piece with the current board.</summary>
        /// <returns>A list of moves that are possible even if they are illegal (pinned piece could move for example).</returns>
        ...
        /// <summary>Get the row on which the piece is.</summary>
        /// <returns>An int between 0 and 7.</returns>
        private int Row => Position / 8;
        
        /// <summary>Get the column on which the piece is.</summary>
        /// <returns>An int between 0 and 7.</returns>
        private int Column => Position % 8;

        /// <summary>Move a piece to a position.</summary>
        /// <param name="newPosition">The position on which we want the piece to be moved.</param>
